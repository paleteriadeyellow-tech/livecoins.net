...
export const giftReactions = [
  {
    ...
    emoji: '🍄',
    name: 'Mari0',
    result: 'Spawn de enemigos en el nivel',
    detail: 'El chat tira un regalo y Mari0 se llena de acción.',
    accent: 'cyan',
  },
  {
    id: 'mslug',
    emoji: '🎖️',
    name: 'Metal Slug',
    result: 'Oleada de enemigos en pantalla',
    detail: 'Un regalo dispara una oleada. El LIVE se pone intenso.',
    accent: 'gold',
  },
  {
    id: 'cubo',
    emoji: '💣',
    name: 'Cubo TNT',
    result: 'Explosión y spawn en Bedrock',
    detail: 'El Cubo TNT estalla y el chat ve el caos en vivo.',
    accent: 'pink',
  },
] as const;
